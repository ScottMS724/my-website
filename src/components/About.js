...
const About = () => {
    return (
        <div className="ui segment">
            ...
            <p className="fontsize20">Prospective employers, please check out my <a href="https://drive.google.com/file/d/1cjKvh2Iieq1BOCWsnA0TA1n_XF5AYbba/view?usp=sharing" target="_blank" rel="noopener noreferrer">resume</a>, as well as my <a href="https://rails-react-blog-24.herokuapp.com/" target="_blank" rel="noopener noreferrer">programming blog</a>.</p>
