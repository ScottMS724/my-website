    ...
    return (
        <div className="ui segment">
            ...
            <div className="ui two column very relaxed grid">
                ...
                <div className="column">
                    <p className="fontsize30">Hi, my name is Scott Silverman. I'm a full stack software developer from New York. Welcome to my website. 
                    I am currently searching for a web developer position.
